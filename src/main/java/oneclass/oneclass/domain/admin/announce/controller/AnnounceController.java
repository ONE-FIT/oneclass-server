package oneclass.oneclass.domain.admin.announce.controller;

import lombok.RequiredArgsConstructor;
import oneclass.oneclass.domain.admin.announce.dto.request.CreateAnnounceRequest;
import oneclass.oneclass.domain.admin.announce.dto.request.UpdateAnnounceRequest;
import oneclass.oneclass.domain.admin.announce.dto.response.AnnounceResponse;
import oneclass.oneclass.domain.admin.announce.repository.AnnounceRepository;
import oneclass.oneclass.domain.admin.announce.service.AnnounceService;
